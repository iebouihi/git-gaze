        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link legacyBehavior  legacyBehavior  href="/admin/settings">
                  <a
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
              ...
              <li className="items-center">
                <Link legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  legacyBehavior  href="/admin/tables">
                  <a
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
